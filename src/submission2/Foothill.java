 ...
 *
 * @author Nikolai Vinogradov & Maksim Tretikov
 */
...
interface CardInterface
{
    ...
    public static final int NUM_SUITS = CardInterface.Suit.values().length;
    ;
    ...
    public boolean set(char value, CardInterface.Suit suit);
